...
// Next parses request bodies by default, which would consume the stream readRaw()
// needs and leave the HMAC computed over an empty string — every webhook would then
// fail signature verification. The signature MUST see exactly what Razorpay sent, so
// body parsing stays off for this route.
